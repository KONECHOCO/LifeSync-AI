...
const i18n = {
    it: {
        ...
        icloudLock: "Archivio Locale Privato",
        backupTitle: "Stato Backup Giornaliero",
        backupDesc: "I dati restano sul dispositivo e vengono usati per il riepilogo giornaliero.",
        btnDlJson: "Scarica JSON",
        btnSyncIcloud: "Aggiorna archivio",
        appToday: "Oggi",
        appHistory: "Storico",
    ...
    en: {
        ...
        icloudLock: "Private Local Archive",
        backupTitle: "Daily Backup Status",
        backupDesc: "Data stays on this device and powers your daily summary.",
        btnDlJson: "Download JSON",
        btnSyncIcloud: "Refresh archive",
        appToday: "Today",
        appHistory: "History",
        appStats: "Stats",
    ...
    es: {
        ...
        icloudLock: "Archivo Local Privado",
        backupTitle: "Estado de la Copia Diaria",
        backupDesc: "Los datos permanecen en este dispositivo y alimentan tu resumen diario.",
        btnDlJson: "Descargar JSON",
        btnSyncIcloud: "Actualizar archivo",
        appToday: "Hoy",
    ...
    fr: {
        ...
        icloudLock: "Archive Locale Privee",
        backupTitle: "Statut de la Sauvegarde",
        backupDesc: "Les donnees restent sur cet appareil et alimentent votre resume quotidien.",
        btnDlJson: "Télécharger JSON",
        btnSyncIcloud: "Actualiser l'archive",
...
function simulateCloudSync() {
    alert("Archivio locale aggiornato.");
}
